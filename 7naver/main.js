...
function checkId(){
    ...
    //.test()메서드는 주어진 문자열이 정규 표현식을 만족하는지
    //판별하고, 그 여부를 true또는 false로 반환합니다.
    //정규식.test(검사할 문장)
...
function checkPw(){
    ...
    if(pw1.value === ""){
        ...
        error[1].innerHTML="8~16자 영문, 대소문자, 숫자, 특자문자를 사용하세요";
        error[1].style.display="block";
...
function isEmailCorrect(){
    var emailPattern=/[a-zA-Z0-9]{2,}@[a-zA-Z0-9]\.[a-zA-Z]{2,}/;
